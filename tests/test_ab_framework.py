...
class TestSampleSizeCalculation:
    ...
    def test_sample_size_increases_with_smaller_mde(self):
        ...
        sample_size_large_mde = ab_test.calculate_sample_size(
            baseline_rate=0.10,
            mde=0.30
        )
        
        sample_size_small_mde = ab_test.calculate_sample_size(
            baseline_rate=0.10,
            mde=0.10
        )
    ...
    def test_sample_size_with_different_ratios(self):
        ...
        sample_size_1_1 = ab_test.calculate_sample_size(
            baseline_rate=0.10,
            mde=0.20,
            ratio=1.0
        )
        
        sample_size_2_1 = ab_test.calculate_sample_size(
            baseline_rate=0.10,
            mde=0.20,
            ratio=2.0
        )
    ...
    def test_sample_size_with_higher_power(self):
        ...
        sample_size_80 = ab_test_80.calculate_sample_size(
            baseline_rate=0.10,
            mde=0.20
        )
        
        sample_size_90 = ab_test_90.calculate_sample_size(
            baseline_rate=0.10,
            mde=0.20
        )
...
class TestBayesianABTest:
    ...
    def test_bayesian_test_basic(self):
        ...
        assert results['prob_b_better_than_a'] + results['prob_a_better_than_b'] == pytest.approx(1.0, abs=1e-10)
